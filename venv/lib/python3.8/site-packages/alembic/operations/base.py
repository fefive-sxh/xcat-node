...
class Operations(util.ModuleClsProxy):
    ...
    def register_operation(cls, name, sourcename=None):
        ...
        def register(op_cls):
            ...
            fn.__func__.__doc__ = (
                ...
                "the :class:`.%s` class, via the :meth:`.%s.%s` method." % (cls.__name__, cls.__name__, name)
            )
    ...
    def invoke(self, operation):
        ...
        """
        fn = self._to_impl.dispatch(operation, self.migration_context.impl.__dialect__)
    ...
    def f(self, name):
        ...
        if conv:
            ...
            raise NotImplementedError("op.f() feature requires SQLAlchemy 0.9.4 or greater.")
