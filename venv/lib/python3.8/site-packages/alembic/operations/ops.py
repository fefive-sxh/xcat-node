...
class DropConstraintOp(MigrateOperation):
    ...
    @classmethod
    def drop_constraint(cls, operations, constraint_name, table_name, type_=None, schema=None):
...
class CreatePrimaryKeyOp(AddConstraintOp):
    ...
    def __init__(self, constraint_name, table_name, columns, schema=None, _orig_constraint=None, **kw):
        self.constraint_name = constraint_name
        self.table_name = table_name
    ...
    @classmethod
    def create_primary_key(cls, operations, constraint_name, table_name, columns, schema=None):
...
class CreateUniqueConstraintOp(AddConstraintOp):
    ...
    def to_constraint(self, migration_context=None):
        ...
        return schema_obj.unique_constraint(
            self.constraint_name, self.table_name, self.columns, schema=self.schema, **self.kw
        )

    @classmethod
    def create_unique_constraint(cls, operations, constraint_name, table_name, columns, schema=None, **kw):
...
class CreateForeignKeyOp(AddConstraintOp):
    ...
    def __init__(
        self, constraint_name, source_table, referent_table, local_cols, remote_cols, _orig_constraint=None, **kw
    ):
        self.constraint_name = constraint_name
    ...
    def to_constraint(self, migration_context=None):
        ...
        return schema_obj.foreign_key_constraint(
            self.constraint_name, self.source_table, self.referent_table, self.local_cols, self.remote_cols, **self.kw
        )
...
class CreateCheckConstraintOp(AddConstraintOp):
    ...
    def __init__(self, constraint_name, table_name, condition, schema=None, _orig_constraint=None, **kw):
        self.constraint_name = constraint_name
        self.table_name = table_name
    ...
    def to_constraint(self, migration_context=None):
        ...
        return schema_obj.check_constraint(
            self.constraint_name, self.table_name, self.condition, schema=self.schema, **self.kw
        )

    @classmethod
    def create_check_constraint(cls, operations, constraint_name, table_name, condition, schema=None, **kw):
...
class CreateIndexOp(MigrateOperation):
    ...
    def __init__(self, index_name, table_name, columns, schema=None, unique=False, _orig_index=None, **kw):
    ...
    def to_index(self, migration_context=None):
        ...
        return schema_obj.index(
            self.index_name, self.table_name, self.columns, schema=self.schema, unique=self.unique, **self.kw
        )

    @classmethod
    def create_index(cls, operations, index_name, table_name, columns, schema=None, unique=False, **kw):
...
class DropIndexOp(MigrateOperation):
    ...
    def __init__(self, index_name, table_name=None, schema=None, _orig_index=None, **kw):
        self.index_name = index_name
        self.table_name = table_name
        self.schema = schema
        self._orig_index = _orig_index
    ...
    @classmethod
    def from_index(cls, index):
        return cls(index.name, index.table.name, schema=index.table.schema, _orig_index=index, **index.kwargs)
    ...
    def to_index(self, migration_context=None):
        ...
        return schema_obj.index(self.index_name, self.table_name, ["x"], schema=self.schema, **self.kw)

    @classmethod
    def drop_index(cls, operations, index_name, table_name=None, schema=None, **kw):
...
class CreateTableOp(MigrateOperation):
    ...
    def __init__(self, table_name, columns, schema=None, _orig_table=None, **kw):
        self.table_name = table_name
        self.columns = columns
        self.schema = schema
        self.kw = kw
    ...
    def from_table(cls, table):
        return cls(
            table.name, list(table.c) + list(table.constraints), schema=table.schema, _orig_table=table, **table.kwargs
        )
    ...
    def to_table(self, migration_context=None):
        ...
        return schema_obj.table(self.table_name, *self.columns, schema=self.schema, **self.kw)
...
class DropTableOp(MigrateOperation):
    ...
    def __init__(self, table_name, schema=None, table_kw=None, _orig_table=None):
        self.table_name = table_name
        self.schema = schema
    ...
    def to_table(self, migration_context=None):
        if self._orig_table is not None:
            return self._orig_table
        schema_obj = schemaobj.SchemaObjects(migration_context)
        return schema_obj.table(self.table_name, schema=self.schema, **self.table_kw)
...
class RenameTableOp(AlterTableOp):
    ...
    @classmethod
    def rename_table(cls, operations, old_table_name, new_table_name, schema=None):
...
class CreateTableCommentOp(AlterTableOp):
    ...
    def __init__(self, table_name, comment, schema=None, existing_comment=None):
        self.table_name = table_name
...
class DropTableCommentOp(AlterTableOp):
    ...
    @classmethod
    def drop_table_comment(cls, operations, table_name, existing_comment=None, schema=None):
...
class AlterColumnOp(AlterTableOp):
    ...
    def reverse(self):
        ...
        all_keys = set(m.group(1) for m in [re.match(r"^(?:existing_|modify_)(.+)$", k) for k in kw] if m)
...
class AddColumnOp(AlterTableOp):
    ...
    @classmethod
    def batch_add_column(cls, operations, column, insert_before=None, insert_after=None):
        """Issue an "add column" instruction using the current
        batch migration context.
...
class DropColumnOp(AlterTableOp):
    ...
    def __init__(self, table_name, column_name, schema=None, _orig_column=None, **kw):
    ...
    def reverse(self):
        ...
        return AddColumnOp.from_column_and_tablename(self.schema, self.table_name, self._orig_column)
    ...
    @classmethod
    def drop_column(cls, operations, table_name, column_name, schema=None, **kw):
