    ...
    def get_section_option(self, section, name, default=None):
        ...
        if not self.file_config.has_section(section):
            raise util.CommandError(
                "No config file %r found, or file has no " "'[%s]' section" % (self.config_file_name, section)
            )
...
class CommandLine(object):
    ...
    def _generate_args(self, prog):
        ...
        parser.add_argument(
            ...
            help="Alternate config file; defaults to value of " 'ALEMBIC_CONFIG environment variable, or "alembic.ini"',
        )
        parser.add_argument(
            "-n",
            "--name",
