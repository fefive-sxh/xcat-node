...
def list_templates(config):
    ...
    for tempname in os.listdir(config.get_template_directory()):
        with open(os.path.join(config.get_template_directory(), tempname, "README")) as readme:
...
def init(config, directory, template="generic", package=False):
    ...
    for file_ in os.listdir(template_dir):
        ...
        if file_ == "alembic.ini.mako":
            ...
            if os.access(config_file, os.F_OK):
                ...
                script._generate_template(file_path, config_file, script_location=directory)
    ...
    util.msg("Please edit configuration/connection/logging " "settings in %r before proceeding." % config_file)
...
def merge(config, revisions, message=None, branch_label=None, rev_id=None):
    ...
    return script.generate_revision(
        rev_id or util.rev_id(), message, refresh=True, head=revisions, branch_labels=branch_label, **template_args
    )
