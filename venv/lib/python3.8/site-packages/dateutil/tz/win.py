...
class tzwinlocal(tzwinbase):
    ...
    def __init__(self):
        ...
        (self._stdmonth, self._stdweeknumber, self._stdhour, self._stdminute) = tup[1:5]  # Last = 5

        self._stddayofweek = tup[7]

        tup = struct.unpack("=8h", keydict["DaylightStart"])

        (self._dstmonth, self._dstweeknumber, self._dsthour, self._dstminute) = tup[1:5]  # Last = 5
